...
exports.inject = function (logger, http_status, urlparser, fs, injected_path, injected_location) {
	...
	injected.build = function (mask, default_path, default_location) {
		...
		var run_path = function (path, url, res) {
			logger.debug("run_path({}, {}, ...)", path, url);
		...
		return function (req, res) {
			logger.trace('work with req: {}, res: {}', req, res)
