...
module.exports = function () {
    ...
    return {
         ...
         *      - function:
         *          the function is returned as is. it shall takes an event as parameter that return true if it is conform to this type of definition
         *      - object:
         *          a validation function will be build with the following rules 
         *              - key: represents a mandatory field with constraint on value
         *              - value: can be
         *                  - true checking the key exists (no type checking)
         *                  - a string starting with '=' followed by a string to match (eg: '=toto')
         *                  - a string in these values 'boolean', 'string', 'number' or 'object' that will be tested using simple typeof
         *                  - a string with value 'array' that will check the value is an array
         *                  - a regex that test the value
         *                  - a function that validate the value
         */
        build : function (definition) {
            ...
            case 'object': {
                ...
                return function(e) {
                    return e.t === v.every(function (f) { return f(e) }) 
                }
            }
            default:
         ...
         * Validator.and
         * 
         * create a validator that is true if every validator in the array parameter return true.
         * 
         *  definitions :
         *      an array of definition
         */
        and : function (definitions) {
            var v = definitions.map(Validator.build)
            return function(e) {
         ...
         * Validator.or
         * 
         * create a validator that is true if at least one validator in the array parameter return true.
         * 
         *  definitions :
         *      an array of definition
         */
