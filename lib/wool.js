...
module.exports = (function () {
  ...
  Wool.prototype._onRuleError = function() {
    return function(data) {
      if (data.s === 'I') this.logger().warn(data.m, data)
      if (data.s === 'E') this.logger().error(data.m, data)
    }.bind(this)
  }

  Wool.prototype.eventReplay = function() {
    return new RuleDispatch(this._rule, this._onRuleError())
  }
