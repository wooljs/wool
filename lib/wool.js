...
module.exports = (function () {
  ...
  Wool.prototype.run = function() {
    ...
    .onLoad(function(count) {
      this._store_events()
      if ('_onReady' in this) { this._onReady(count) } else { this._isReady = true }
    }.bind(this))
    return this
  }
  ...
  Wool.prototype._load_events = function() {
    ...
    .pipe(sd.on('error', this._buildErrorHandler('While dispatching:')))
