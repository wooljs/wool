...
exports['should treat GET /r/x/{id} and return 200 with header and data'] = function (test) {
	...
	var _biz = { on: verify.add('biz.on()', function(type) {
		test.equal(type, 'x');
		return { getById: verify.add('biz.getById()',function (id, cb) { test.equal(id, 42); cb(_d);}) };
	}) };
...
exports['should treat GET /r/x/ and return 200 with header and data'] = function (test) {
	...
	var _biz = { on: verify.add('biz.on()', function(type) {
		test.equal(type, 'x');
		return { find: verify.add('biz.find()',function (crit, cb) { test.deepEqual(crit, _crit); cb(_d);}) };
	}) };
...
exports['should treat POST /r/x/'] = function (test) {
	...
	var _biz = { on: verify.add('biz.on()', function(type) {
		test.equal(type, 'x');
		return { save: verify.add('biz.save()',function (obj,cb) { test.deepEqual(obj, _obj); obj.id=_created_obj_id; cb(obj.id);}) };
	}) };
